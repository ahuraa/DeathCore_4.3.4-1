...
public:
        ...
        void CreatePet(Player *player, Creature * m_creature, uint32 entry) {
                ...
                if(player->getClass() != CLASS_HUNTER) {
                        m_creature->MonsterWhisper("Você não é um Hunter!", player->GetGUID());
                        player->PlayerTalkClass->SendCloseGossip();
                        return;
                }
 
                if(player->GetPet()) {
                        m_creature->MonsterWhisper("Primeiro deve abandonar o seu pet.", player->GetGUID());
                        player->PlayerTalkClass->SendCloseGossip();
                        return;
                }
                ...
                player->PlayerTalkClass->SendCloseGossip();
                m_creature->MonsterWhisper("Já tem o seu novo Pet!", player->GetGUID());
        }
        ...
        bool OnGossipHello(Player *player, Creature * m_creature)
        {
                ...
                player->ADD_GOSSIP_ITEM(7, "Domar um novo Pet.", GOSSIP_SENDER_MAIN, 1000);
                if (player->CanTameExoticPets())
                {
                        player->ADD_GOSSIP_ITEM(7, "Domar um novo Pet Exotic.", GOSSIP_SENDER_MAIN, 50);
                }
                player->ADD_GOSSIP_ITEM(2, "Mostre-me os estabulos!", GOSSIP_SENDER_MAIN, GOSSIP_OPTION_STABLEPET);
                player->ADD_GOSSIP_ITEM(1, "Mostre-me a sua comida.", GOSSIP_SENDER_MAIN, GOSSIP_OPTION_VENDOR);
                player->ADD_GOSSIP_ITEM(4, "Sair", GOSSIP_SENDER_MAIN, 150);
        ...
        bool OnGossipSelect(Player *player, Creature * m_creature, uint32 sender, uint32 action)
        {
                ...
                case 150:
    				...
    				case 1000: // Submenu
										player->ADD_GOSSIP_ITEM(4, "<- [Menu Principal]", GOSSIP_SENDER_MAIN, 100);
										player->ADD_GOSSIP_ITEM(5, "[Next Page] ->", GOSSIP_SENDER_MAIN, 10000);
                                        player->ADD_GOSSIP_ITEM(4, "Domar um Bat!", GOSSIP_SENDER_MAIN, 1001);
                                        player->ADD_GOSSIP_ITEM(4, "Domar um Bear!", GOSSIP_SENDER_MAIN, 1002);
                                        player->ADD_GOSSIP_ITEM(4, "Domar um Bird of Prey!", GOSSIP_SENDER_MAIN, 1003);
                                        player->ADD_GOSSIP_ITEM(4, "Domar um Boar!", GOSSIP_SENDER_MAIN, 1004);
										player->ADD_GOSSIP_ITEM(4, "Domar um Carrion Bird!", GOSSIP_SENDER_MAIN, 1005);
										player->ADD_GOSSIP_ITEM(4, "Domar um Cat!", GOSSIP_SENDER_MAIN, 1006);
										player->ADD_GOSSIP_ITEM(4, "Domar um Crab!", GOSSIP_SENDER_MAIN, 1007);
										player->ADD_GOSSIP_ITEM(4, "Domar um Crocolisk!", GOSSIP_SENDER_MAIN, 1008);
										player->ADD_GOSSIP_ITEM(4, "Domar um Dragonhawk!", GOSSIP_SENDER_MAIN, 1009);
										player->ADD_GOSSIP_ITEM(4, "Domar um Gorilla!", GOSSIP_SENDER_MAIN, 1010);
										player->ADD_GOSSIP_ITEM(4, "Domar um Hyena!", GOSSIP_SENDER_MAIN, 1011);
										player->ADD_GOSSIP_ITEM(4, "Domar um Moth!", GOSSIP_SENDER_MAIN, 1012);
										player->ADD_GOSSIP_ITEM(4, "Domar um Nether Ray!", GOSSIP_SENDER_MAIN, 1013);
										player->ADD_GOSSIP_ITEM(4, "Domar um Raptor!", GOSSIP_SENDER_MAIN, 1014);
                                        player->SEND_GOSSIP_MENU(1, m_creature->GetGUID());
                                        break;
						...
						case 10000: // Submenu
										...
										player->ADD_GOSSIP_ITEM(4, "Domar um Ravager!", GOSSIP_SENDER_MAIN, 1015);
										player->ADD_GOSSIP_ITEM(4, "Domar um Scorpid!", GOSSIP_SENDER_MAIN, 1016);
										player->ADD_GOSSIP_ITEM(4, "Domar um Serpent!", GOSSIP_SENDER_MAIN, 1017);
										player->ADD_GOSSIP_ITEM(4, "Domar um Spider!", GOSSIP_SENDER_MAIN, 1018);
										player->ADD_GOSSIP_ITEM(4, "Domar um Sporebat!", GOSSIP_SENDER_MAIN, 1019);
										player->ADD_GOSSIP_ITEM(4, "Domar um Tallstrider!", GOSSIP_SENDER_MAIN, 1020);
										player->ADD_GOSSIP_ITEM(4, "Domar um Turtle!", GOSSIP_SENDER_MAIN, 1021);
										player->ADD_GOSSIP_ITEM(4, "Domar um Warpstalker!", GOSSIP_SENDER_MAIN, 1022);
										player->ADD_GOSSIP_ITEM(4, "Domar um Windserpent!", GOSSIP_SENDER_MAIN, 1023);
										player->ADD_GOSSIP_ITEM(4, "Domar um Wolf!", GOSSIP_SENDER_MAIN, 1024);
										player->SEND_GOSSIP_MENU(1, m_creature->GetGUID());
                                        break;
				...
				case 1003:
					...
					case 10003:
                        player->ADD_GOSSIP_ITEM(4, "<- [Menu Principal]", GOSSIP_SENDER_MAIN, 100);
						player->ADD_GOSSIP_ITEM(4, "<- [Voltar]", GOSSIP_SENDER_MAIN, 1003);
					...
					case 10006:
						player->ADD_GOSSIP_ITEM(4, "<- [Menu Principal]", GOSSIP_SENDER_MAIN, 100);
						player->ADD_GOSSIP_ITEM(4, "<- [Voltar]", GOSSIP_SENDER_MAIN, 1006);
					...
					case 10018:
						player->ADD_GOSSIP_ITEM(4, "<- [Menu Principal]", GOSSIP_SENDER_MAIN, 100);
						player->ADD_GOSSIP_ITEM(4, "<- [Voltar]", GOSSIP_SENDER_MAIN, 1018);
					...
					case 10024:
						player->ADD_GOSSIP_ITEM(4, "<- [Menu Principal]", GOSSIP_SENDER_MAIN, 100);
						player->ADD_GOSSIP_ITEM(4, "<- [Voltar]", GOSSIP_SENDER_MAIN, 1024);
